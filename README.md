...
the tab when you click on a volume control on the page.  We do this because interacting
with a volume control shows a clear intent to change the volume, so the tab mute
shouldn't stay in the way.
